...
class User:
    ...
    def push(self):
        self.DB.update_user(self.USERNAME, self.PASSWORD,
                            self.name, self.role, self.email, self.phone)
...
class UserManagement:
    ...
    def pull(self):
        ...
        for i in self.DB.get_users():
            users.append(User(
                self.DB, i['username'], i['password'], i['name'], i['role'], i['email'], i['phone']))
        self.users = users
    ...
    def add_user(self, username, password, name, role, email, phone):
        self.users.append(User(self.DB, username, password,
                          name, role, email, phone, new=True))
